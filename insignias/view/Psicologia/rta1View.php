...
<div class="row">
  <div class="col-md-12">
    <h1>Gestion de notas Industrial Ruta 1</h1>
  </div>
</div>
...
<table class="table">
  <thead>
    <tr>
      ...
      <th scope="col">Periodo</th>
l     <th scope="col"><?php echo $curso10?></th>
      <th scope="col">Periodo</th>                      
  ...
  <tbody>
    ...
    foreach ($array_notas as $key) {
        ...
        $prom = (
            ...
            $key->getCurso7() + $key->getCurso8() + $key->getCurso9() +
            $key->getCurso10()) /10;
        if(
    ...
    <tr>
      ...
      <td><?php echo $key->getCurso10()?></td>
      <td><?php echo $key->getPeriodo10()?></td>                            
      <td><?php echo $prom?></td>
      <td><?php echo $ins?></td>
    </tr>
